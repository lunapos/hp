...
/**
 * デモ案内（トップページの #demo）へ誘導するボタン。
 *
 * App Store へ直接飛ばすとトークンを知らないままアプリを開くことになり、
 * 端末認証画面で止まってしまう。まず手順とトークンを見せてから
 * App Store に送るため、サイト内の導線はすべてここを経由させる。
 */
export default function DemoLinkButton({
  label,
  location,
  variant = "primary",
  size = "lg",
