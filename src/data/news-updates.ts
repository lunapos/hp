...
export const updateItems: NewsItem[] = [
  // --- 2026-03-16 ---
  {
    ...
    date: "2026-03-16",
    title: "コラム: 「俺がいないと回らない」が店を壊す",
    summary:
      "オーナー依存の構造的リスクと、仕組み化で店を強くする方法について解説する記事を公開しました。",
    category: "開発アップデート",
    project: "HP",
    content: [
      "新しいコラム記事「『俺がいないと回らない』が店を壊す」を公開しました。",
      "",
      "オーナーが頑張るほどスタッフが育たなくなる構造的ループ、任せた後の売上回復パターン、事業譲渡時のオーナー依存リスクなどを解説しています。",
    ],
  },
  // --- 2026-03-11 ---
  {
