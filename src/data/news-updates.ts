...
export const updateItems: NewsItem[] = [
  // --- 2026-08-09 ---
  {
    slug: "floor-public-demo",
    date: "2026-08-09",
    title: "登録不要で触れる体験デモを公開しました",
    summary: "POS（Floor）の画面を、登録もインストールもなしにブラウザからそのまま試せる体験デモを公開しました。営業中の店舗を再現した状態から、卓の開店・オーダー入力・会計まで一通り操作できます。",
    category: "開発アップデート",
    project: "Floor",
    content: "「実際の操作感を先に確かめたい」というご要望を受けて、体験デモを公開しました。\n\n## 触れる内容\n・稼働中の卓・空席・会計待ちが並んだフロアマップ\n・卓を開いて人数・指名・同伴を設定する流れ\n・メニューからのオーダー入力と、セット料金・指名料・サービス料・消費税の自動計算\n・キャストの出退勤状況の一覧\n・レジ締めと日次レポート（売上・組数・客単価・キャスト別ランキング）\n\n## ご利用にあたって\n・登録・インストールは不要です。ブラウザからそのまま開けます\n・操作した内容はお使いの端末内にのみ保存され、実際の店舗データには一切影響しません\n・画面上部の「最初から」を押すと、いつでも初期状態に戻せます\n・iPad・タブレットでの操作を想定した画面ですが、パソコンからもお試しいただけます",
  },
  // --- 2026-08-07 ---
  {
