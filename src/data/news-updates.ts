...
export const updateItems: NewsItem[] = [
  // --- 2026-03-07 ---
  {
    slug: "hp-article-top-cast-team",
    date: "2026-03-07",
    title: "コラム公開: ナンバーがチームを引き上げる",
    summary:
      "売上トップのキャストが周りの子にも声をかけてチーム全体を引き上げる仕組みについてのコラムを公開。既存記事との相互リンクも追加。",
    category: "開発アップデート",
    project: "HP",
    content: [
      "新規コラム「ナンバーが『自分の売上』だけ見ていると、店は伸びない」を公開しました。",
      "",
      "・ナンバーの子が後輩に声をかけることでチーム全体の数字が上がる仕組み",
      "・スタッフの役割は「橋渡し」——自然に教え合う関係を作る方法",
      "・「まだ輝いていないキャストを一緒に輝かせる」記事との相互リンク追加",
    ].join("\n"),
  },
  {
