...
export const updateItems: NewsItem[] = [
  // --- 2026-05-22 ---
  {
    ...
    date: "2026-05-22",
    title: "Admin: 全ページのエラーハンドリングを強化・データ取得の高速化",
    summary: "管理画面の全ページでエラーメッセージ表示に対応。通信エラーが発生した場合にユーザーへ通知されるようになりました。キャスト管理ページではデータ取得を並列化し、表示速度を改善しました。",
    category: "開発アップデート",
    project: "Admin",
    content: "管理画面の安定性と使いやすさを改善しました。\n\n## エラーハンドリング強化（全ページ共通）\n・ダッシュボード、メニュー管理、セットプラン管理、テーブル管理、キャスト管理、店舗設定の全ページでエラー表示に対応\n・データ取得失敗時に赤いエラーバナーを表示（「データの取得に失敗しました。ページを再読み込みしてください。」）\n・保存・削除操作の失敗時もアラートで通知\n・Supabaseのエラーレスポンスを正確にキャッチして表示\n\n## キャスト管理: データ取得の並列化\n・キャスト一覧とシフト情報の取得を並列（Promise.all）に変更\n・逐次取得から並列取得へ変更することで初期表示を高速化",
  },
  // --- 2026-04-27 ---
  {
    slug: "articles-may-schedule",
    date: "2026-04-27",
    title: "コラム: 5月の記事8本を予約公開設定",
    summary: "5/12〜5/30にかけて8本の新記事を予約公開しました。同伴の帰り道、飲み方教育、黒服の観察力、好かれるvs指名が入る、常連の使い方、No.1ランキング、個人開業の壁、風営法規制の歴史。",
    category: "開発アップデート",
    project: "HP",
    content: "5月に公開予定の記事8本を配置しました。\n\n・5/12 同伴の帰り道に何を話しているかで関係が分かる\n・5/15 「飲み方」を教えられる店がキャストを長く育てる\n・5/18 黒服の「観察力」は目ではなく違和感で動いている\n・5/20 好かれるキャストと指名が入るキャストの違い\n・5/22 「常連」という言葉の使い方を間違えている店\n・5/25 No.1という肩書きは誰のためにあるのか\n・5/28 「個人で店を持つ」が難しくなっている本当の理由\n・5/30 風営法の規制強化で業界はどう変わってきたか",
  },
  // --- 2026-04-24 ---
  {
