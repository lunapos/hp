...
export const newsItems: NewsItem[] = [
  // --- 2026-02-26 ---
  {
    ...
    summary:
      "ヘッダーナビを店舗オーナー向けに絞り込み、投資・出資/パートナーをフッターへ移動。メディア→コラムにリネーム、URLパスも /media → /column に変更。",
    category: "開発アップデート",
    project: "HP",
    content: [
      "## ナビゲーション分割",
      ...
      "",
      "### ヘッダー（店舗オーナー向け）",
      "・トップ / 機能紹介 / ロードマップ / ニュース / コラム / 運営について / お問い合わせ",
      "",
      "### フッターへ移動",
      "・投資・出資 / パートナー",
      "",
      "## メディア → コラムへリネーム",
      "ブログ的なコンテンツであることを明確にするため「メディア」を「コラム」に変更しました。",
