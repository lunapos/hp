...
export const newsItems: NewsItem[] = [
  ...
  {
    slug: "app-v0-9-0-admin-cast-web",
    date: "2026-03-02",
    title: "v0.9.0 管理画面・キャスト画面デプロイ",
    summary:
      "Admin/CastのGitHubリポジトリ作成、Vercelデプロイ、カスタムドメイン設定を実施。",
    category: "開発アップデート",
    project: "App",
    content: [
      "管理画面（Admin）とキャスト画面（Cast）のデプロイ環境を整備しました。",
      "",
      "## 実施内容",
      "・GitHub リポジトリ作成（lunapos/admin, lunapos/cast）",
      "・Vercel プロジェクト作成・自動デプロイ連携",
      "・カスタムドメイン設定（admin.lunapos.jp, cast.lunapos.jp）",
      "・SSL証明書の自動発行",
      "",
      "## Admin 主要機能",
      "・Supabase接続クライアント",
      "・売上CSVエクスポート（BOM付きExcel対応）",
      "・レポート・キャスト・テーブル・メニュー管理画面",
      "",
      "## Cast 主要機能",
      "・ログイン認証・ダッシュボード",
      "・シフト提出・確認",
  ...
  {
    slug: "hp-article-navigation",
    date: "2026-03-02",
    title: "v0.14.0 記事ナビゲーション追加",
    summary:
  ...
  {
    slug: "app-v0-8-1-floor-cast-edit-sync-error",
    date: "2026-03-02",
    title: "v0.8.1 Floor: キャスト編集・同期エラーUI",
    summary:
      "iPadアプリにキャスト編集フォームと同期失敗時のエラー表示を追加しました。",
    category: "開発アップデート",
    project: "App",
    content: [
      "Floorアプリの操作性と信頼性を改善しました。",
      "",
      "## キャスト編集（EditCastSheet）",
      "・キャスト管理画面から源氏名・本名・シフト・送り先を編集可能",
      "・既存のAddCastSheetと統一されたUI",
      "",
      "## 同期エラー表示",
      "・Supabase同期失敗時にヘッダー下にオレンジのバナーを表示",
      "・エラー内容（来店/テーブル/会計/シフト/顧客/出金）を日本語で通知",
      "・5秒後に自動消去、手動で閉じることも可能",
    ].join("\n"),
  },
  // --- 2026-03-01 ---
  {
