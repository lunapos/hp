...
export const newsItems: NewsItem[] = [
  // --- 2026-03-07 ---
  {
    slug: "article-tax-audit-ksk2",
    date: "2026-03-07",
    title: "新規コラム5本を追加",
    summary:
      "キャバ嬢の確定申告ガイド、国税庁AI税務調査（KSK2）の影響と対策、キャバクラ初めてガイド、黒服キャリアと店選びなど5本の記事を追加しました。",
    category: "お知らせ",
    project: "HP",
    content: [
      "オウンドメディア（コラム）に新規記事5本を追加しました。",
      "",
      "## 追加記事",
      "・キャバ嬢・ホステスのための確定申告ガイド — 税務調査の実態データ、経費にできるもの、税理士判断基準",
      "・国税庁AI税務調査で水商売はどう変わる？ — 2026年9月KSK2移行の影響と店舗・キャスト双方の対策",
      "・キャバクラ初めてガイド — 料金の仕組み・相場、入店〜退店の流れ、マナー、ぼったくり対策",
      "・黒服が成り上がるには「どの店で働くか」が全て — ポジション別年収、拡大グループで働くメリット",
      "",
      "確定申告記事では国税庁の2024事務年度データを引用し、「ホステス・ホスト」が申告漏れランキング3位（1件あたり約2,968万円）であることを紹介。KSK2記事では2026年9月のAI税務調査システム移行が水商売に与える影響を深掘りしています。",
    ].join("\n"),
  },
  // --- 2026-03-06 ---
  {
