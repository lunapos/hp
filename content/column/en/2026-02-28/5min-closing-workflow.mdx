...
And it's shared in real time. Hostesses can check their own sales and nomination counts on the place. Owners can see how the night is going without being at the venue. You don't have to wait for the closing routine -- everyone has access to the same information while the numbers are still in motion.
